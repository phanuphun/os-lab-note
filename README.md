...
wifi adapter ที่ใช้จะเป็น RT8188FTV จะใช้สำหรับ ubuntu mate ที่เป็นฝั่ง client [อ่านวิธีติดตั้งได้ที่นี่](https://github.com/1999AZZAR/use-RTL8188FTV-on-linux)
